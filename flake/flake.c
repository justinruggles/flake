...
print_help(FILE *out)
{
    fprintf(out, "usage: flake [options] <input.wav> [-o output.flac]\n"
                 ...
                 "                        3 = -b 4096 -t 2 -l 6   -m 1 -r 3   -s 1\n"
                 "                        4 = -b 4096 -t 2 -l 8   -m 1 -r 3   -s 1\n"
                 "                        5 = -b 4096 -t 2 -l 8   -m 1 -r 6   -s 1\n"
                 "                        6 = -b 4096 -t 2 -l 8   -m 2 -r 8   -s 1\n"
                 "                        7 = -b 4096 -t 2 -l 8   -m 3 -r 8   -s 1\n"
                 "                        8 = -b 4096 -t 2 -l 12  -m 3 -r 8   -s 1\n"
                 "                        9 = -b 4096 -t 2 -l 12  -m 6 -r 8   -s 1\n"
                 "                       10 = -b 4096 -t 2 -l 12  -m 5 -r 8   -s 1\n"
